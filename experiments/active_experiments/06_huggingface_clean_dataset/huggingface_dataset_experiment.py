#!/usr/bin/env python3
"""
Experiment with HuggingFace Datasets
===================================

Test scalable graph implementation with real datasets.
"""
...
class HuggingFaceDatasetExperiment:
    """Run experiments with real HuggingFace datasets."""
    ...
    def process_dataset(self, dataset_name: str, max_docs: int = None):
        ...
        dataset_results['episodes_created'] = len(self.agent.l2_memory.episodes)
        ...
        print(f"  Episodes created: {dataset_results['episodes_created']}")
    ...
    def compare_datasets(self):
        ...
        for dataset_name, results in self.results['datasets'].items():
            if results['successful'] > 0:
                comparison_data.append({
                    ...
                    'Episodes': results['episodes_created'],
                    ...
                    'Conflicts': results['graph_stats'].get('recent_conflicts', 0)
                })
        ...
        if comparison_data:
            ...
            # Save comparison
            csv_file = Path(__file__).parent / 'dataset_comparison.csv'
    ...
    def save_results(self):
        ...
        results_file = Path(__file__).parent / f'huggingface_results_{timestamp}.json'
...
def main():
    """Run the HuggingFace dataset experiment."""
    print("=== HuggingFace Dataset Experiment ===")
    print(f"Start time: {datetime.now()}")
    
    experiment = HuggingFaceDatasetExperiment()
