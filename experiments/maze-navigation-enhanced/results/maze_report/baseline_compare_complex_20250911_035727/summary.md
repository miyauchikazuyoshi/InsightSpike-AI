...
| random | 1 | 6.733 | 6.733 | 0.743 | 0.130 |
| simple | 1 | 14.429 | 14.429 | 0.752 | 0.080 |

## Timing (Simple Aggregated)

| metric | mean_ms |
|--------|---------|
| timing_wiring_mean_ms | 7.002 |
| timing_snapshot_mean_ms | 0.710 |
| timing_gedig_mean_ms | 141.787 |
