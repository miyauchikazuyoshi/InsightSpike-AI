"""
Test message passing configuration with 20 continuous data points
"""
...
def test_message_passing():
    """Test message passing configuration"""
    print("Testing Message Passing Configuration")
    print("="*60)
    ...
    try:
        ...
        print("Agent initialized with message passing enabled")
        ...
        # Process questions
        print("\nProcessing 20 questions with message passing...")
