...
try:
    if os.getenv('INSIGHTSPIKE_LITE_MODE'):
        ...
        from tests.mocks.mock_factory import create_mock_components
        GraphEditDistance, InformationGain, InsightDetector = create_mock_components()
    else:
        from insightspike.algorithms.graph_importance import GraphEditDistance
        from insightspike.algorithms.information_gain import InformationGain
        from insightspike.detection.eureka_spike import EurekaSpike as InsightDetector
