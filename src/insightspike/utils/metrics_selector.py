...
try:
    from .advanced_graph_metrics import delta_ged as advanced_delta_ged, delta_ig as advanced_delta_ig
...
class MetricsSelector:
    ...
    def _select_ged_method(self, algorithm: str) -> Callable:
        ...
        if algorithm == "hybrid":
            ...
            if algorithm != "simple":
                logger.warning(f"Requested GED algorithm '{algorithm}' not available, using simple")
    ...
    def _select_ig_method(self, algorithm: str) -> Callable:
        ...
        if algorithm == "hybrid":
            ...
            if algorithm != "simple":
                logger.warning(f"Requested IG algorithm '{algorithm}' not available, using simple")
