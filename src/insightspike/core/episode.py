...
class Episode:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "embedding": self.vec.tolist() if isinstance(self.vec, np.ndarray) else self.vec
        }
...
def create_episode(vec: np.ndarray, text: str, c: float = 0.5, metadata: Optional[Dict] = None) -> Episode:
