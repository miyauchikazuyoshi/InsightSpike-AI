...
class StandaloneL3GraphReasoner:
    ...
    def __init__(self, config: Optional[Union[Dict[str, Any], StandaloneConfig]] = None):
    ...
    def _calculate_reward(self, metrics: Dict[str, float], conflicts: Dict[str, float]) -> float:
...
def create_standalone_reasoner(config: Optional[Dict[str, Any]] = None) -> StandaloneL3GraphReasoner:
