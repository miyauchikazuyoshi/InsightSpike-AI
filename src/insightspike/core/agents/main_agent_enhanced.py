...
class EnhancedMainAgent(MainAgent):
    ...
    def initialize(self):
        ...
        if self.use_enhanced_l2 and not isinstance(
        ...
        try:
            ...
            if enhanced_stats:
                ...
                result["integration_info"] = {
                    "total_integrations": integration_stats.get(
                ...
                result["splitting_info"] = {
                    ...
                    "new_episodes_created": splitting_stats.get(
                        "total_new_episodes", 0
                    ),
                }

            logger.info(
                f"Enhanced episode processing complete. Total episodes: {len(self.l2_memory.episodes)}"
            )
    ...
    def configure_episode_management(
        self,
    ...
    def trigger_global_optimization(self):
        ...
        if hasattr(self.l2_memory, "_check_global_conflicts"):
            ...
            logger.info(
                f"Global optimization complete. Episodes split: {splitting_stats.get('episodes_split', 0)}"
            )
            ...
            return {"success": False, "error": "Enhanced L2 not available"}
    ...
    def get_episode_graph_info(self, episode_idx: int) -> Dict[str, Any]:
        ...
        if hasattr(self.l2_memory, "_calculate_episode_conflict"):
            ...
            info["needs_splitting"] = (
                conflict_score > self.l2_memory.splitting_config.conflict_threshold
            )
