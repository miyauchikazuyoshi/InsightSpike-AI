...
class ProcessingPipeline:
    ...
    def add_memory(self, content: str, metadata: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            embedding = embedding_result.get("embedding") if isinstance(embedding_result, dict) else embedding_result
    ...
    def search(self, query: str, top_k: int = 10) -> SearchResult:
        ...
        try:
            ...
            query_embedding = query_embedding_result.get("embedding") if isinstance(query_embedding_result, dict) else query_embedding_result
    ...
    def process(self, input_data: Any) -> Any:
        ...
        if isinstance(input_data, str):
            ...
            if "query" in input_data:
                ...
                return self.add_memory(input_data["content"], input_data.get("metadata"))
