...
class DataStoreMainAgent:
    ...
    def process(self, 
        ...
        try:
            ...
            episode_id = self.memory_manager.store_episode(
                text=text,
                c_value=0.5,  # Initial confidence
                metadata=metadata
            )
    ...
    def _generate_reasoning(self, text: str, spike_info: Dict, 
                          related_episodes: List[Dict]) -> Optional[str]:
    ...
    def _build_reasoning_prompt(self, text: str, spike_info: Dict, 
