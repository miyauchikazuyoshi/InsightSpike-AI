...
class L2MemoryAdapter:
    ...
    def save_metadata(self, metadata: Dict[str, Any]) -> bool:
        ...
        return self.datastore.save_metadata(
            metadata, key="l2_metadata", namespace=self.namespace
        )
...
class L3GraphAdapter:
    ...
    def save_graph(self, graph: Any, graph_id: str) -> bool:
        ...
        Returns:
            Success status
        """
        return self.datastore.save_graph(
            graph, graph_id=graph_id, namespace=self.namespace
        )
    ...
    def save_analysis_history(self, history: List[Dict[str, Any]]) -> bool:
        ...
        """
        return self.datastore.save_metadata(
            {"history": history}, key="analysis_history", namespace=self.namespace
        )
    ...
    def load_analysis_history(self) -> List[Dict[str, Any]]:
        ...
        """
        metadata = self.datastore.load_metadata(
            key="analysis_history", namespace=self.namespace
        )
