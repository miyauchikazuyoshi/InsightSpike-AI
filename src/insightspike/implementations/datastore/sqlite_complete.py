"""
Complete SQLiteDataStore (deprecated helper)
===========================================

This module historically contained helper methods that were merged into the
canonical `sqlite_store.SQLiteDataStore`. It remains for reference and will be
removed after consolidation. Please use the factory entrypoint instead:
...
_warnings.warn(
    "sqlite_complete is deprecated; use DataStoreFactory.create('sqlite')",
    DeprecationWarning,
    stacklevel=2,
)

# The following functions are kept for reference during consolidation.
# The canonical implementation exists in sqlite_store.SQLiteDataStore.
