"""
SQLite Data Store Implementation with Configurable Vector Index
==============================================================

SQLite-based implementation of AsyncDataStore for scalable local storage.
Uses aiosqlite for async operations and ConfigurableVectorIndex for flexible vector search.
"""
