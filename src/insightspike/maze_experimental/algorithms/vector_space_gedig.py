"""EXPERIMENTAL MODULE: vector_space_gedig
Status: experimental
Category: experimental
PromotionCriteria: Demonstrate measurable geDIG optimization speedup vs discrete search
...
_warnings.warn(
    "insightspike.maze_experimental.algorithms.vector_space_gedig is experimental; API may change without notice",
    UserWarning,
    stacklevel=2,
)
