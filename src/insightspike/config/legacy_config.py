...
DEPRECATION WARNING:
This module is deprecated and will be removed in 3 months.
Please migrate to the new Pydantic-based configuration system:
- Use InsightSpikeConfig from insightspike.config.models
- See docs/development/config_migration.md for migration guide
"""
