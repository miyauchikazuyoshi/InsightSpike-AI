...
class ConfigLoader:
    ...
    def _load_from_file(self, config_path: Optional[Union[str, Path]] = None) -> Dict[str, Any]:
        ...
        if config_path:
            ...
            if env_path:
                ...
                for default_path in ["config.yaml", "config.json", ".insightspike.yaml"]:
            ...
            with open(path, "r") as f:
                if path.suffix in [".yaml", ".yml"]:
                    try:
                        ...
                        logger.warning("PyYAML not installed. Cannot load YAML config files. Use JSON instead or install PyYAML.")
                        return {}
                    ...
                    try:
                        ...
                        try:
                            ...
                            logger.warning("Could not parse config file as JSON and PyYAML not available")
                            return {}
