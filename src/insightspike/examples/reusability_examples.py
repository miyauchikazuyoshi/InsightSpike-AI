...
from insightspike.core.interfaces.generic_interfaces import (
    EnvironmentInterface, EnvironmentState, InsightDetectorInterface,
    RewardNormalizer, StateEncoder, TaskType
)
...
def example_1_basic_maze_agent():
    ...
    print(f"Summary: {summary['total_insights']} insights in {summary['total_episodes']} episodes")
    print()
...
def example_3_standalone_graph_reasoner():
    ...
    print(f"  Metrics: ΔGED={result['metrics']['delta_ged']:.3f}, "
    ...
    print(f"Second analysis - Spike: {result2['spike_detected']}, "
...
def example_4_different_maze_environments():
    ...
    for size in [6, 10, 15]:
        ...
        summary = agent.get_performance_summary()
        print(f"  Insights: {insights}, Avg reward: {summary['avg_episode_reward']:.2f}")
...
class SimpleCustomEnvironment(EnvironmentInterface):
    ...
    def get_action_space(self):
        ...
        return ActionSpace(action_type="discrete", action_dim=3, 
