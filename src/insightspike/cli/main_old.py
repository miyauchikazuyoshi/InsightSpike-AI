...
# Use: python scripts/run_true_insight_experiment.py
...
# Use: python scripts/compare_experiments.py
...
# Removed experiment_suite - use individual experiments
...
# Moved demo command to new CLI (spike demo)
...
# Moved insights command to new CLI (spike insights)
    try:
...
# Moved insights_search to new CLI (spike insights search)
...
# Removed insights_validate - maintenance command
...
# Removed insights_cleanup - maintenance command
    try:
        registry = InsightFactRegistry()
...
# Removed test_safe - development command
