...
def calculate_information_gain(vectors_before: np.ndarray, 
                             vectors_after: np.ndarray) -> float:
    """
    ...
    logger.debug(f"IG calculation: H(before)={h_before:.3f}, H(after)={h_after:.3f}, ΔIG={delta_ig:.3f}")
