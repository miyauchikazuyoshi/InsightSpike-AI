...
class EntropyCalculator:
    ...
    def calculate_delta_entropy(
        self, data_before: Any, data_after: Any
    ) -> Tuple[float, EntropyResult, EntropyResult]:
        """
    ...
    def calculate_insight_score(
        self, data_before: Any, data_after: Any, normalize: bool = True
    ) -> Dict[str, float]:
        """
        ...
        return {
            ...
            if abs(delta_content) > abs(delta_structure)
            else "structure",
        }
