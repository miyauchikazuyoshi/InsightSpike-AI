...
class ProperDeltaGED:
    ...
    def calculate_delta_ged(self, current_graph: Any, 
    ...
    def _calculate_ged(self, g1: Any, g2: Any) -> float:
        ...
        if (hasattr(g1, 'number_of_nodes') and hasattr(g2, 'number_of_nodes') and
            g1.number_of_nodes() <= 10 and g2.number_of_nodes() <= 10):
            try:
...
def proper_delta_ged(current_graph: Any, 
                    previous_graph: Optional[Any] = None,
                    reference_graph: Optional[Any] = None) -> float:
    """
