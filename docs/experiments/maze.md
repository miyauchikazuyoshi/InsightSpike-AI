...
## Harder setting check
25x25 with `max_steps=120` (seeds=3) and `max_steps=250` (seeds=3).

| success_rate | avg_steps | gmin_mean | ag_rate | dg_rate | Notes |
|---:|---:|---:|---:|---:|---|
| 0.00 | 120.0 | -0.3590 | 0.106 | 0.917 | `maze25_s120_s3_full.json` |
| 0.33 | 230.7 | -0.3297 | 0.110 | 0.915 | `maze25_s250_s3_full.json` |
...
- `experiments/maze-query-hub-prototype/results/harder/maze25_s120_s3_full.json`
- `experiments/maze-query-hub-prototype/results/harder/maze25_s120_s3_full_steps.json`
- `experiments/maze-query-hub-prototype/results/harder/maze25_s250_s3_full.json`
- `experiments/maze-query-hub-prototype/results/harder/maze25_s250_s3_full_steps.json`
