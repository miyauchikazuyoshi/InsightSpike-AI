...
25x25 with `max_steps=120` (seeds=3) and `max_steps=250` (seeds=1).

| success_rate | avg_steps | gmin_mean | ag_rate | dg_rate | Notes |
|---:|---:|---:|---:|---:|---|
| 0.00 | 120.0 | -0.3590 | 0.106 | 0.917 | `maze25_s120_s3_full.json` |
| 0.00 | 250.0 | -0.2774 | 0.128 | 0.908 | `maze25_s250_s1_full.json` |
...
- `experiments/maze-query-hub-prototype/results/harder/maze25_s250_s1_full.json`
- `experiments/maze-query-hub-prototype/results/harder/maze25_s250_s1_full_steps.json`
