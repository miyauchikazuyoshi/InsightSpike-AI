...
- **docs/architecture/ は 2026-07-03 に鮮度監査・負債返済済み**(コア文書は実装と同期。
  threelayer / QHub の設計文書と、THREELAYER_SEARCH / WAKE_SLEEP_WAKE の図を新設。
  古い図 4 組は docs/archive/diagrams/ へ)。残る ⚠ マーカーは architecture/README.md 参照
