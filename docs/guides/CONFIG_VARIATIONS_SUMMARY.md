...
# Query-Centric Local Evaluation (Default 2025-10)
metrics:
  query_centric: true        # Evaluate ΔGED/ΔIG on local k-hop subgraph
  query_topk_centers: 3      # Use top-K retrieved nodes as centers
  query_radius: 1            # Hop radius

# Algorithm Selection (Default 2025-10)
graph:
  ged_algorithm: advanced    # GeDIGCore via MetricsSelector
