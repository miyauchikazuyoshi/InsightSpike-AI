...
\begin{tikzpicture}[scale=0.85, every node/.style={transform shape}]
  ...
  \node[red!70, font=\small\bfseries] at (0, 6.9) {Multi-hop Reach (DG)};
  \node[red!70, font=\footnotesize] at (0, 6.3) {評価: $\Delta \mathrm{SP}$};

  \node[blue!70, font=\small\bfseries] at (0, 2.4) {0-hop Orbit (AG)};
  \node[blue!70, font=\footnotesize] at (0, 1.9) {評価: $\Delta \mathrm{EPC}, \Delta H$};
