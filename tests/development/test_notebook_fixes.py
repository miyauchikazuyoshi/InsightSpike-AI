            ...
            def __init__(self, experiment_name):
                ...
                if "/content" in os.getcwd():
                    self.checkpoint_dir = Path(
                        f"/content/checkpoints/{experiment_name}"
                    )
                else:
...
def main():
    ...
    print(
        f"{'✅' if numpy_ok else '❌'} NumPy compatibility: {'Working' if numpy_ok else 'Failed'}"
    )
    print(
        f"{'✅' if components_ok else '❌'} Mock components: {'Working' if components_ok else 'Failed'}"
    )
    print()
