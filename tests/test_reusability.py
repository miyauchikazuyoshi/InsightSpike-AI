...
def test_imports():
    ...
    try:
        ...
        from insightspike.core.interfaces.generic_interfaces import (
            TaskType, EnvironmentState, InsightMoment, EnvironmentInterface
        )
...
def test_environment_adapter():
    ...
    try:
        ...
        print(f"✅ Action space: {action_space.action_type}, dim: {action_space.action_dim}")
