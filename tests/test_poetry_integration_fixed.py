...
class TestPoetryIntegration:
    ...
    def test_export_requirements(self, platform_info):
        ...
        with patch.object(integration.dependency_resolver, 'resolve_dependencies', return_value=mock_deps):
            ...
            assert f"# Generated requirements for {platform_info.platform}" in requirements
