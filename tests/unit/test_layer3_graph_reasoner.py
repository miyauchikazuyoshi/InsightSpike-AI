...
class TestL3GraphReasoner:
    ...
    def graph_reasoner(self, config_experiment):
        ...
        with patch("insightspike.implementations.layers.layer3_graph_reasoner.ScalableGraphBuilder"):
    ...
    def test_analyze_documents_with_previous_graph(self, graph_reasoner, mock_graph):
        ...
        assert result["metrics"]["delta_ged"] != 0.0 or result["metrics"]["delta_ig"] != 0.0
