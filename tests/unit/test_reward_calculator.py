...
class TestRewardCalculatorInitialization:
    ...
    def test_init_with_partial_config(self):
        ...
        with patch(
            "insightspike.features.graph_reasoning.reward_calculator.getattr",
            custom_getattr,
        ):
            calculator = RewardCalculator(config)
...
class TestBaseRewardCalculation:
    ...
    def test_calculate_reward_basic(self, calculator):
        ...
        metrics = {
            "delta_ged": -0.5,
            "delta_ig": 0.3,
        }  # GED is negative for improvement
        conflicts = {"total": 0.2}
...
class TestTotalRewardCalculation:
    ...
    def test_total_reward_all_zero(self, calculator):
        ...
        metrics = {"delta_ged": 0.0, "delta_ig": 0.0, "graph_size_current": 0}
        conflicts = {"total": 0.0}
...
class TestEdgeCases:
    ...
    def test_reward_with_nan_values(self, calculator):
        ...
        metrics = {"delta_ged": np.nan, "delta_ig": 0.5, "graph_size_current": 100}
    ...
    def test_reward_with_inf_values(self, calculator):
        ...
        metrics = {"delta_ged": -np.inf, "delta_ig": np.inf, "graph_size_current": 100}
    ...
    def test_reward_with_very_large_values(self, calculator):
        ...
        metrics = {"delta_ged": -1e10, "delta_ig": 1e10, "graph_size_current": 1e10}
    ...
    def test_reward_type_consistency(self, calculator):
        ...
        metrics = {"delta_ged": -0.5, "delta_ig": 0.3, "graph_size_current": 100}
