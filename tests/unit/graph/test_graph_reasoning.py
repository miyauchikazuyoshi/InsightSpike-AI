...
class TestRewardCalculator:
    ...
    def test_calculate_reward_with_conflicts(self):
        ...
        assert rewards["total"] < rewards["base"], "Conflicts should reduce total reward"
...
class TestGraphReasoningIntegration:
    ...
    def test_analyzer_and_calculator_consistency(self):
        ...
        for case in test_cases:
            spike = analyzer.detect_spike(case["metrics"], case["conflicts"], case["thresholds"])
            ...
            if spike:
                assert quality > 0.3, "Spike detection should correlate with decent quality"
                assert rewards["total"] > 0, "Spike detection should give positive reward"
            
            # Quality and reward should correlate
            if quality > 0.7:
                assert rewards["total"] > rewards["base"] * 0.8, "High quality should give good reward"