...
class TestEmbeddingManager:
    ...
    def test_model_loading_with_env_setup(self, mock_get_config, mock_st, mock_torch):
        ...
        mock_st.assert_called_once_with(
            manager.model_name, device="cpu", cache_folder=None, trust_remote_code=False
        )
    ...
    def test_model_loading_fallback_on_error(self, mock_get_config):
        ...
        with patch(
            "insightspike.utils.embedder.SentenceTransformer",
...
class TestGetModelFunction:
    ...
    def test_get_model_returns_global_manager(self):
        ...
        with patch(
            "insightspike.utils.embedder.EmbeddingManager"
