...
class TestQueryInsightsInPrompt:
    ...
    def test_insights_included_in_standard_prompt(self):
        ...
        query_state.absorbed_concepts = ["entropy", "information", "reversibility", "computation", "energy", "disorder"]
        ...
        assert "Thermodynamics and information theory share mathematical structure" in prompt
    ...
    def test_insights_included_in_simple_prompt(self):
        ...
        query_state = Mock()
        query_state.insights_discovered = ["Entropy connects physics and information theory fundamentally"]
    ...
    def test_no_insights_when_query_state_missing(self):
        ...
        context = {
            "retrieved_documents": [
                {"text": "Basic document about entropy"}
            ]
        }
    ...
    def test_insight_truncation(self):
        ...
        query_state.insights_discovered = [f"Insight {i}: " + "x" * 100 for i in range(10)]
