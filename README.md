...
| Maze stage-2 (Wake-Sleep-Wake) | Three pre-registered ablations (2026-07): v1 — original undirected propagation contributed **zero** (headline 71.9%→95.3% re-attributed to curriculum+10D). v2 — **trajectory-Q replay propagation, self-navigation: eval steps −39%** (p=4.0e-05, n=23 paired). v3 — **replicated on 18 fresh seeds, −51%** (115 vs 234, p=2.9e-04); lift-of-failed-warmups remains inconclusive (underpowered, recorded as such) | [`experiments/maze/graph_persistent_dg/`](experiments/maze/graph_persistent_dg/) |
