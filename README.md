...
| Maze stage-2 (Wake-Sleep-Wake) | Two pre-registered ablations (2026-07): v1 — original undirected propagation contributed **zero** (29/30 identical trajectories; headline 71.9%→95.3% re-attributed to curriculum+10D). v2 — redesigned **trajectory-Q replay propagation, self-navigation: eval steps −39%** (124 vs 202, p=4.0e-05, n=23 paired), dead-end encounters 0.17 vs 4.74/run; first isolated sleep contribution | [`experiments/maze/graph_persistent_dg/`](experiments/maze/graph_persistent_dg/) |
